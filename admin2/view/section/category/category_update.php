  ...
  <div class="insert__data__section">
    <div class="insert__data__section--wrap">
      ...
      <div class="insert__data__wrap">
        <form method="POST" action="index.php?section=update_category" class="insert__data__form insert__value__form" enctype="multipart/form-data">
          <div class="form__control">
            <div class="form__control--wrap">
              <label class="form__control--name">Tên danh mục</label>
              <input type="text" name="ten_loai_sp" class="form__control--value" value="<?=$ten_loai_sp?>">
            </div>
          </div>
